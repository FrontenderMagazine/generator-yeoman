...
`frontender`, я получил довольно объёмные функции. (ссылку)
...
Внимательно просмотрев `index.js`
можно обнаружить метод установки зависимостей, вызываемый по завершении 
...
Как я и говорил, `package.json` и `bower.json` тоже могут быть шаблонами, 
в них также можно использовать ответы пользователя. В генераторе `frontender` они также являются шаблонами и доступны для изучения на GitHub. (ссылку)
