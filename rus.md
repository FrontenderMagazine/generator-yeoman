...
[`webapp`][generator-webapp] имеет наиболее общие задачи для *Grunt*, 
которые, скорее всего, вам 
...
Если вам не нравится концепция 
...
Как и обещал, в результате написания статьи я реализовал генератор, требования к которому вы могли заметить в начале статьи. 
Повторюсь, этот генератор реализует несколько скудный рабочий процесс, в него 
включены элементарные задачи и плагины для Grunt. 
Но он выполняет возложенные на него функции, а именно — способен 
отобразить основные возможности скаффолдера и стать хорошим примером для 
написания вашего гораздо более специфичного генератора.
